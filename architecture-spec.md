...
┌──────┬──────────┬─────────┬──────────┬────────────┐
│  ch  │  M[15b]  │  S[6b]  │  zp[16b] │ bias_q[32b]│
├──────┼──────────┼─────────┼──────────┼────────────┤
│  0   │  16022   │   22    │    0     │   -1340    │
│  1   │  18901   │   23    │    0     │    562     │
│ ...  │   ...    │   ...   │   ...    │    ...     │
...
每通道存储: 15 + 6 + 16 + 32 = 69 bits，对齐到 10 bytes (80 bits)
512 通道: 5 KB
```
...
| **片上存储总计** | — | — | — | **103 KB** | — |
| **整芯片估算** | **~58,300** | **~30,000** | **400** | **103 KB** | **100%** |
...
|------|--------|-----|-----|--------|------|---------|-----|---------|
| **Tiny** (8×8, INT8, 32b) | ~8.3K | ~1.8K | ~4.4K | ~1.8K | 35KB | ~20K | 100 | ~0.08mm² |
| **Base** (16×16, INT8, 32b) | ~25K | ~3.7K | ~8.8K | ~1.8K | 67KB | ~45K | 400 | ~0.20mm² |
| **Pro** (16×16, INT16, 40b) | ~33K | ~3.7K | ~8.8K | ~1.8K | 103KB | ~58K | 400 | ~0.23mm² |
| **Pro+** (16×16, INT16, 44b) | ~35K | ~3.7K | ~8.8K | ~1.8K | 103KB | ~60K | 400 | ~0.24mm² |
| **Max** (16×16, INT16, 48b) | ~37K | ~3.7K | ~8.8K | ~1.8K | 131KB | ~63K | 400 | ~0.40mm² |
